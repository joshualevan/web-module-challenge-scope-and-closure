...
1. In your own words, define closure (1-2 sentences).
   Closure is a nesting of functions wherein the outer function is called to give access to an inner function and its lexical (surrounding) environment. Closure allows the bundle to store data.
